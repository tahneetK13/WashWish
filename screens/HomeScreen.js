  ...
  return (
    <>
      <ScrollView style={{ marginTop: 50 }}>
        ...
        >
          <MaterialIcons name="location-on" size={30} color="#6CB4EE" />
          <View>
          ...
          <Pressable onPress={() => navigation.navigate("Profile")} style={{ marginLeft: "auto", marginRight: 7 }}>
            <Image
              ...
              source={{
                uri: "https://lh3.googleusercontent.com/ogw/AOLn63GQhdpSLl3cRWu7Z5t37wHNTvlWaIPlJLpDCHXD3g=s32-c-mo",
              }}
            />
          </Pressable>
        </View>
        ...
        >
          ...
          <Feather name="search" size={24} color="#6CB4EE" />
        </View>
        {/* Image Carousel */}
        <Carousel />
        {/* Services Component */}
